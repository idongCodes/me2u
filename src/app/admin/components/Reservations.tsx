  ...
  const handleBulkDelete = async () => {
    ...
    try {
      ...
      modal.alert({
        type: "success",
        title: "Success",
        message: `${selectedIds.length} records have been deleted.`
      });
    } catch (err) {
            ...
            {reservations.slice(0, isExpanded ? reservations.length : 3).map((res) => {
              ...
              return (
                <div 
                  ...
                  className={`bg-white border rounded-2xl p-6 shadow-sm transition-all cursor-pointer relative group ${
                    isSelected ? 'border-skyblue ring-2 ring-skyblue/20' : 'border-gray-200'
